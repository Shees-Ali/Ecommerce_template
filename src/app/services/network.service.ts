...
export class NetworkService {
  ...
  getParametersByCategory(category: any) {
    return this.httpGetResponse('parameters/by-category?category=' + category);
  }

  // Get Category
  // getCategory(Parameters : any) {
  //   return this.httpGetResponse(',Parameters);
  // }
  getCategory(obj: any) {
    const params = this.serialize(obj);
    let url = 'category' + (params ? '?' + params : '');
  ...
  getCurrentUser() {
    return this.httpGetResponse('users/get-current-user');
  }
